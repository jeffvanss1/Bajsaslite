...
setInterval(()=>{ 
  const main2VisibleNow=mediaPanel.classList.contains('show')&&String(bActiveStream||'').toLowerCase().replace(/\s+/g,'')==='main2';
  if(main2VisibleNow && !document.hidden) syncMediaClock();
},300000);
