javascript:(async function(){
 ...
 const APP_VERSION = 'lite 5.2-lobby-demo';
 const DEBUG = true;
 const debugBuffer = [];
...
margin-left: 2px !important;
 ...
 bOfflineTimers.set(k, timer);
     ...
     const bGameModal=document.createElement('div');bGameModal.className='bajsas-game-modal';bGameModal.innerHTML='<div class="bajsas-game-window"><div class="bajsas-game-head"><b>⚫ BajSAS Checkers</b><button class="custom-stream-btn" data-game-close>✕</button></div><div class="bajsas-game-controls"><input data-room-name placeholder="Room name" maxlength="32" style="flex:1;min-width:100px;background:#211d18;color:#fff;border:1px solid #8b7759;padding:5px"><button class="custom-stream-btn" data-room-create>Create</button><select data-room-list><option>No rooms</option></select><button class="custom-stream-btn" data-room-join>Join</button><button class="custom-stream-btn" data-room-watch>Watch</button><button class="custom-stream-btn" data-room-refresh>↻</button><span data-game-status>Lobby</span></div><div class="bajsas-game-board" data-game-board></div><div class="bajsas-game-score"><div class="bajsas-game-player"><div data-red-name>Red</div><div class="bajsas-game-clock" data-red-clock>5:00</div><small data-red-count>12 pieces</small></div><b>VS</b><div class="bajsas-game-player"><div data-black-name>Black</div><div class="bajsas-game-clock" data-black-clock>5:00</div><small data-black-count>12 pieces</small></div></div><div class="bajsas-game-actions"><button class="custom-stream-btn" data-game-draw>Offer Draw</button><button class="custom-stream-btn" data-game-resign>Resign</button><button class="custom-stream-btn" data-room-close>Close Room</button></div></div>';targetContainer.appendChild(bGameModal);
     ...
     function bRenderLobby(){bRoomList.innerHTML=bLobbyRooms.length?bLobbyRooms.map(r=>`<option value="${r.gameId}">${r.roomName} • ${r.status} • ${r.host}${r.opponent?' vs '+r.opponent:''} • 👁${r.spectators}</option>`).join(''):'<option value="">No public rooms</option>';}
