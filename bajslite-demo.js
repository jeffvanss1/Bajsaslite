javascript:(async function(){
 ...
 const APP_VERSION = 'lite 5.4-lobby-ui-demo';
 const DEBUG = true;
 const debugBuffer = [];
...
margin-left: 2px !important;
 ...
 bOfflineTimers.set(k, timer);
     ...
     function bShowLobby(){bGamePlay.style.display='none';bRoomList.style.display='block';bGameBack.style.display='none';bGameStatus.textContent='Public Lobby';bGameSend({type:'checkers_lobby_list'});}
     function bShowBoard(){bRoomList.style.display='none';bGamePlay.style.display='block';bGameBack.style.display='flex';bRenderGame();}
