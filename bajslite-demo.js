javascript:(async function(){
 ...
 const APP_VERSION = 'lite 5.1-game-demo';
 const DEBUG = true;
 const debugBuffer = [];
...
margin-left: 2px !important;
 ...
 bOfflineTimers.set(k, timer);
     ...
     const bGameModal=document.createElement('div');bGameModal.className='bajsas-game-modal';bGameModal.innerHTML='<div class="bajsas-game-window"><div class="bajsas-game-head"><b>⚫ BajSAS Checkers</b><button class="custom-stream-btn" data-game-close>✕</button></div><div class="bajsas-game-controls"><select data-game-user></select><button class="custom-stream-btn" data-game-invite>Invite</button><span data-game-status>Select a player</span></div><div class="bajsas-game-board" data-game-board></div><div class="bajsas-game-score"><div class="bajsas-game-player"><div data-red-name>Red</div><div class="bajsas-game-clock" data-red-clock>5:00</div><small data-red-count>12 pieces</small></div><b>VS</b><div class="bajsas-game-player"><div data-black-name>Black</div><div class="bajsas-game-clock" data-black-clock>5:00</div><small data-black-count>12 pieces</small></div></div><div class="bajsas-game-actions"><button class="custom-stream-btn" data-game-draw>Offer Draw</button><button class="custom-stream-btn" data-game-resign>Resign</button></div></div>';targetContainer.appendChild(bGameModal);
